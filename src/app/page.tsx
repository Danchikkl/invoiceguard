    ...
    <div className="min-h-screen bg-paper">
        ...
        <div className="max-w-5xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              { step: '02', title: 'Send with one click', desc: 'Invoice lands in your client\'s inbox with a clean PDF attachment.' },
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div className="bg-mist rounded-xl p-6 border border-gray-100">
            ...
            {[
              ...
              { label: 'Friendly reminder', sub: 'Day 3 · polite tone', done: true, active: false },
              { label: 'Follow-up', sub: 'Day 7 · warmer nudge', done: false, active: true },
              { label: 'Urgent reminder', sub: 'Day 14 · firm tone', done: false, active: false },
              { label: 'Final notice', sub: 'Day 21 · last attempt', done: false, active: false },
      ...
      <section className="bg-ink py-16">
        <div className="max-w-xl mx-auto px-6 text-center">
          ...
          <p className="text-gray-400 mb-6 text-sm">Free plan includes 3 active invoices and automated reminders.</p>
