      ...
      <div className="w-full max-w-sm">
        ...
        <div className="card p-6">
          <button
            ...
            disabled={loading}
            className="w-full flex items-center justify-center gap-3 border border-gray-200 rounded-lg px-4 py-3 text-sm font-medium text-ink hover:bg-mist transition-colors disabled:opacity-50"
          >
        ...
        <p className="text-center text-xs text-slate mt-4">Free plan · No credit card needed</p>
      </div>
    </div>
  )
}
