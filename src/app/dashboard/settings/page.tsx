  ...
  return (
    <div className="p-8 max-w-lg">
      ...
      <div className="card p-6 mt-4">
        <h2 className="text-sm font-medium text-ink mb-2">Email setup</h2>
        <p className="text-sm text-slate mb-3">Invoices are sent via Gmail SMTP. Make sure your server has these environment variables set:</p>
        <div className="bg-mist rounded p-3 font-mono text-xs text-lead space-y-1">
          <div>GMAIL_USER=your@gmail.com</div>
          <div>GMAIL_APP_PASSWORD=xxxx xxxx xxxx xxxx</div>
        </div>
        <p className="text-xs text-slate mt-2">
          Get an app password at <a href="https://myaccount.google.com/apppasswords" target="_blank" rel="noopener noreferrer" className="text-accent hover:underline">myaccount.google.com/apppasswords</a>
        </p>
      </div>

      <div className="card p-6 mt-4">
        <h2 className="text-sm font-medium text-ink mb-2">Automated reminders</h2>
        <p className="text-sm text-slate mb-3">Reminders run automatically when the cron job hits <code className="bg-mist px-1 rounded text-xs">/api/reminders</code>.</p>
